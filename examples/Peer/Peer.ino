...
void setup()
{
  ...
  BMC36.setDeviceRole(Peer);          //set device role 
}
...
void RFMessage_Process()
{
  ...
  { 
   ...
   case 0x03:    
      if(Flag_Pairing)
      {
        BMC36.writePairPackage(SA_Peer_Pair|SA_Pairing,16,DataBuff);                //Send request pairing packets during pair mode  
      } 
     if(Flag_PairSuccess)     
       {
